...
(function ($, undefined) {
    ...
    $.fn.gantt = function (options) {
        ...
        var settings = {
            ...
            waitText: "Đang tải lịch hướng dẫn viên...",
            // navigation
            navigate: "buttons",
            scrollToToday: true,
            // cookie options
        ...
        var core = {
            ...
            leftPanel: function (element) {
                ...
                $.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage &&
                        ...
                        if (entry.desc) {
                            entries.push(
                                '<div style="width:85%;" class="row desc row' + i +
                                ' " id="RowdId_' + i + dataId + '">' +
                                '<span class="fn-label' +
            ...
            createProgressBar: function (label, desc, classNames, dataObj,i) {
                ...
                label = label || "";
                var _id = "bar" + i;
                var bar = $('<div class="bar '+_id+'"><div class="fn-label">' + label + '</div></div>')
                    ...
                    if (i >= element.pageNum * settings.itemsPerPage &&
                        ...
                        $.each(entry.values, function (j, day) {
                            ...
                            case "hours":
                                ...
                                _bar = core.createProgressBar(day.label, day.desc, day.customClass, day.dataObj,i);
        ...
        var tools = {
            ...
            getMaxDate: function (element) {
                ...
                default:
					...
					var lastdate = new Date(maxDate.getFullYear(), maxDate.getMonth()+1, 1)-1;
            ...
            getMinDate: function (element) {
                ...
                default:
                    minDate.setHours(0, 0, 0, 0);
					var firstdate = new Date(minDate.getFullYear(), minDate.getMonth(), 1);
					//console.log("m: "+minDate);
					//console.log("f: "+new Date(firstdate));
                    minDate=firstdate;
                }
                return minDate;
            },
