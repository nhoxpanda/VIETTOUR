...
$("#btnEdit").click(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            /*** doanh nghiệp ***/
            $("#edit-province-company").select2();
            $("#edit-district-company").select2();
            $("#edit-ward-company").select2();
            ...
            $("#edit-province-personal").select2();
            $("#edit-district-personal").select2();
            $("#edit-ward-personal").select2();
            ...
            $("#edit-province-company").change(function () {
                $.getJSON('/Home/DistrictList?id=' + $('#edit-province-company').val(), function (data) {
                    var items = '<option>Quận/Huyện</option>';
                    $.each(data, function (i, gd) {
                        items += "<option value='" + gd.Value + "'>" + gd.Text + "</option>";
                    });
                    $('#edit-district-company').html(items);
                });
            })

            $("#edit-district-company").change(function () {
                $.getJSON('/Home/WardList?id=' + $('#edit-district-company').val(), function (data) {
                    var items = '<option>Phường/Xã</option>';
                    $.each(data, function (i, gd) {
                        items += "<option value='" + gd.Value + "'>" + gd.Text + "</option>";
                    });
                    $('#edit-ward-company').html(items);
                });
            })

            //

            $("#edit-province-personal").change(function () {
                $.getJSON('/Home/DistrictList?id=' + $('#edit-province-personal').val(), function (data) {
                    var items = '<option>Quận/Huyện</option>';
                    $.each(data, function (i, gd) {
                        items += "<option value='" + gd.Value + "'>" + gd.Text + "</option>";
                    });
                    $('#edit-district-personal').html(items);
                });
            })

            $("#edit-district-personal").change(function () {
                $.getJSON('/Home/WardList?id=' + $('#edit-district-personal').val(), function (data) {
                    var items = '<option>Phường/Xã</option>';
                    $.each(data, function (i, gd) {
                        items += "<option value='" + gd.Value + "'>" + gd.Text + "</option>";
                    });
                    $('#edit-ward-personal').html(items);
                });
            })
        }
    });
