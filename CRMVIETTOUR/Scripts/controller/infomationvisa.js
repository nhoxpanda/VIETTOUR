...
$("#country-insert-categoryvisa").select2();
...
$("#btnEdit").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: '/InfomationVisaManage/EditInfoVisa',
        ...
        success: function (data) {
            ...
            $("#country-edit-categoryvisa").select2();
...
function btnSearchCountryVisa() {
    var dataPost = { id: $("#customer-select2 option:selected").val() };
    $.ajax({
        type: "POST",
        url: '/InfomationVisaManage/SearchCountryVisa',
        data: JSON.stringify(dataPost),
        contentType: "application/json; charset=utf-8",
        dataType: "html",
        success: function (data) {
