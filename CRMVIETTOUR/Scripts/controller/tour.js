...
$("#btnInsertVisa").click(function () {
    var cusID = $('#product_selected option:selected').val();
...
function btnCreateVisa() {
    if ($("table#tableDictionary").find('tr.oneselected').length === 0) {
        ...
        var tourID = $("table#tableDictionary").find('tr.oneselected').find("input[type='checkbox']").val();
        var dataPost = { id: tourID };
        ...
        $("#tourIDHidden").val(tourID);
        $('#insert-type-visa option[value=1066]').attr('selected', 'selected');
