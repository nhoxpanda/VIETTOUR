    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/website").Include(
                       ...
                       "~/Content/assets/datatable/jquery.dataTables.js",
                       "~/Content/assets/datatable/dataTables.bootstrap.js",
                       "~/Content/assets/datatable/jquery.dataTables.columnFilter.js",
                       "~/Scripts/SelectCheckbox.js",
                       "~/Scripts/gmap3.js",
            ...
            bundles.Add(new StyleBundle("~/Content/website").Include(
                        ...
                        "~/Content/Site.css",
                        "~/Content/assets/datatable/dataTables.bootstrap.css",
                        "~/Content/color-picker/css/bootstrap-colorpicker.min.css",
                        "~/Content/color-picker/css/bootstrap-colorpicker-plus.css",
                        "~/Content/loading/css/custom.css",
                        "~/Content/loading/css/iosOverlay.css",
                        "~/Content/loading/css/prettify.css"));
        }
    }
}
