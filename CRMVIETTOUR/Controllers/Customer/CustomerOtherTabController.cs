    ...
    public class CustomerOtherTabController : BaseController
    {
        ...
        public async Task<ActionResult> DeleteAppointment(int id)
        {
            ...
            try
            {
                ...
                UpdateHistory.SaveHistory(53, "Xóa lịch hẹn: " + item.Title + ", khách hàng: " + _customerRepository.FindId(item.CustomerId).Code);
                //
        ...
        public async Task<ActionResult> DeleteContactHistory(int id)
        {
            try
            {
                ...
                UpdateHistory.SaveHistory(56, "Xóa lịch sử liên hệ: " + item.Request + ", khách hàng: " + _customerRepository.FindId(item.CustomerId).Code);
                //
        ...
        public async Task<ActionResult> DeleteContact(int id)
        {
            ...
            try
            {
                ...
                UpdateHistory.SaveHistory(1097, "Xóa người liên liên hệ: " + item.FullName + ", khách hàng: " + _customerRepository.FindId(item.CustomerId).Code);
                //
        ...
        [HttpPost]
        public ActionResult CheckCodeVisa(string code)
        {
            var check = _customerVisaRepository.GetAllAsQueryable().FirstOrDefault(p => p.VisaNumber == code);
            if (check != null)
            {
                return Json(0, JsonRequestBehavior.AllowGet);
            }
        ...
        public async Task<ActionResult> DeleteContract(int id)
        {
            ...
            try
            {
                ...
                UpdateHistory.SaveHistory(1104, "Xóa hợp đồng: " + items.Code + " - " + items.Name + ", khách hàng: " + _customerRepository.FindId(items.CustomerId).Code);
                //
                var listId = id.ToString().Split(',').ToArray();
        ...
        public async Task<ActionResult> DeleteProgram(int id)
        {
            ...
            try
            {
                ...
                //end file
                //
                UpdateHistory.SaveHistory(1106, "Xóa chương trình: " + program.Code + " - " + program.Name + ", khách hàng: " + _customerRepository.FindId(program.CustomerId).Code);
                //
        ...
        public async Task<ActionResult> DeleteQuotation(int id)
        {
            ...
            try
            {
                ...
                var listId = id.ToString().Split(',').ToArray();
                //
                UpdateHistory.SaveHistory(1107, "Xóa báo giá: " + documentFile.Code + ", khách hàng: " + _customerRepository.FindId(documentFile.CustomerId).Code);
                //
        ...
        public async Task<ActionResult> DeleteTicket(int id)
        {
            ...
            try
            {
                ...
                UpdateHistory.SaveHistory(1105, "Xóa code vé: " + item.Code + ", khách hàng: " + _customerRepository.FindId(item.CustomerId).Code);
                //
        ...
        public async Task<ActionResult> CreateTour(TourViewModel model, FormCollection form)
        {
            try
            {
                ...
                model.SingleTour.Code = GenerateCode.TourCode();
        ...
        public async Task<ActionResult> UpdateTour(TourViewModel model, FormCollection form)
        {
            try
            {
                ...
                {
                    UpdateHistory.SaveHistory(1103, "Cập nhật tour: " + model.SingleTour.Name + ", khách hàng: " + _customerRepository.FindId(model.SingleTour.CustomerId).Code);
                    ...
                    UpdateHistory.SaveHistory(1103, "Cập nhật tour, code: " + model.SingleTour.Code + ", khách hàng: " + _customerRepository.FindId(model.SingleTour.CustomerId).Code);
        ...
        public async Task<ActionResult> DeleteTour(int id)
        {
            ...
            try
            {
                ...
                UpdateHistory.SaveHistory(1103, "Xóa tour: " + items.Code + " - " + items.Name + ", khách hàng: " + _customerRepository.FindId(items.CustomerId).Code);
                //
        ...
        public async Task<ActionResult> CreateGuide(TourGuideViewModel model, FormCollection form, HttpPostedFileBase Image, IEnumerable<HttpPostedFileBase> File)
        {
            try
            {
                Permission(clsPermission.GetUser().PermissionID, 1103);
